...
# Redirect Events
get('/coffee/?') { redirect'https://winvin.churchsuite.co.uk/events/9zjuldqb' }
get('/breakthrough/?') { redirect'https://winvin.churchsuite.co.uk/events/p5zm3dry' }
get('/ministry/?') { redirect'https://winvin.churchsuite.co.uk/events/ssfojfcd' }
get('/catchup/?') { redirect'https://winvin.churchsuite.co.uk/events/aottjtqi' }
...
get('/illuminate/?') { redirect 'https://winvin.churchsuite.co.uk/events/bo6nttt1' }
get('/radiate/?') { redirect 'https://winvin.churchsuite.co.uk/events/afhpf53b' }
...
get('/bringhope/?') { redirect 'https://winvin.churchsuite.co.uk/events/tjm3ctqg' }
