...
jQuery(document).ready(function() {
  ...
  jQuery('#services-list .service').click(function(){
    ...
    jQuery(this).addClass('active');
    var target = jQuery(this).attr('id');
    jQuery("#"+curSkills+"-skills").slideUp(500, 'easeInOutExpo',function(){jQuery("#"+target+"-skills").slideDown(500, 'easeInOutExpo')});
...
jQuery(document).ready(function(){
  ...
  jQuery('#google-map').gMap({ longitude: '-1.3062', latitude: '51.05286',
    panControl: true,
    zoomControl: true,
    zoomControlOptions: {
    ...
    zoom:15,
    markers: [
      { longitude: '-1.3062', latitude: '51.05286',}
      ]
  });
});
